...
from policy_research.env.robocasa.env import RobocasaEnv
from policy_research.env.robocasa.factory import get_subtasks
        ...
        **kwargs,
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(
                ...
                desc=f"Eval {policy_name} in RoboCasa::{self.task_name} {chunk_idx+1}/{n_chunks}",
                leave=False,
